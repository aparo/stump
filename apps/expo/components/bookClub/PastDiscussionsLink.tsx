...
export function PastDiscussionsLink({ data }: Props) {
	...
	return (
		...
		>
			<View className="squircle ios:rounded-[2rem] gap-6 rounded-3xl bg-black/5 p-3 dark:bg-white/10 relative flex-grow flex-row overflow-hidden">
				{backgroundGradient && (
					<LinearGradient
				...
				{isLinkDisabled && (
					<View className="items-end justify-end">
						<Text className="text-base font-medium text-right text-foreground-muted">
							No past discussions
						</Text>
					</View>
				)}
