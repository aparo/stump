	...
	({ className, placeholderClassName, isInvalid, ...props }, ref) => {
		return (
			<TextInput
				ref={ref}
				className={cn(
					'native:h-14 native:text-lg native:leading-[1.25] squircle h-10 rounded-2xl px-3 text-base file:font-medium lg:text-sm border border-edge bg-background text-foreground file:border-0 file:bg-transparent',
