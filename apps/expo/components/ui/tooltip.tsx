			...
			>
				<TextClassContext.Provider value="text-sm native:text-base text-popover-foreground">
					<TooltipPrimitive.Content
						...
						className={cn(
							'border-border bg-popover web:animate-in web:fade-in-0 web:zoom-in-95 squircle rounded-md px-3 py-1.5 shadow-md z-50 overflow-hidden border shadow-foreground/5 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
							className,
						)}
						{...props}
					/>
