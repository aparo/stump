...
mod tests {
	...
	fn find_for_user() {
		...
		assert_eq!(
			stmt_str,
			r#"SELECT  FROM "libraries" WHERE "libraries"."id" NOT IN (SELECT "library_id" FROM "library_exclusions" WHERE "library_exclusions"."user_id" = '0ad39398-ce6a-4bcc-b044-719163a07c53')"#
		);
	}
}
