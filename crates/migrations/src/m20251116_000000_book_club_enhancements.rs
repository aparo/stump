...
#[derive(DeriveIden)]
pub enum BookClubBookSuggestions {
	Table,
	Id,
	BookClubId,
	Title,
...
#[derive(DeriveIden)]
pub enum BookClubBookSuggestionLikes {
	Table,
	Id,
	Timestamp,
	LikedById,
...
#[derive(DeriveIden)]
pub enum BookClubDiscussionMessage {
	Table,
	Id,
	Content,
	Timestamp,
...
#[derive(DeriveIden)]
pub enum BookClubDiscussionMessageReactions {
	Table,
	Id,
	Emoji,
	CustomEmojiId,
...
#[derive(DeriveIden)]
pub enum OldBookClubDiscussionMessage {
	CreatedAt,
	UpdatedAt,
}
